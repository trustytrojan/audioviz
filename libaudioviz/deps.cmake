...
if(WIN32 AND NOT FFTW3_FOUND)
	if(CMAKE_SYSTEM_PROCESSOR MATCHES "x86_64|AMD64")
		...
		FetchContent_Declare(fftw URL https://www.fftw.org/fftw-3.3.5.tar.gz)
		FetchContent_MakeAvailable(fftw)
...
if(AUDIOVIZ_USE_IMGUI)
	...
	if(NOT SFML_FOUND)
		...
		# because imgui-sfml's cmake sets SFML_STATIC_LIBRARIES based on BUILD_SHARED_LIBS
	endif()
	set(IMGUI_DIR ${imgui_SOURCE_DIR})
	FetchContent_Declare(imgui-sfml URL https://github.com/SFML/imgui-sfml/archive/v3.0.tar.gz)
	FetchContent_MakeAvailable(imgui-sfml)
    target_compile_definitions(audioviz PUBLIC AUDIOVIZ_IMGUI)
