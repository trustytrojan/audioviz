...
if(WIN32)
	if(CMAKE_SYSTEM_PROCESSOR MATCHES "x86_64|AMD64")
		...
		target_include_directories(luaviz-intermediate PUBLIC ${LUA_PATH}/include)
		target_link_directories(luaviz-intermediate PUBLIC ${LUA_PATH}/lib)
		target_link_libraries(luaviz-intermediate PUBLIC ${LUA_LIB_NAME})
	else()
		...
		target_link_libraries(luaviz-intermediate PUBLIC Lua::Library)
	endif()
else()
	find_library(LUA_LIB NAMES lua REQUIRED)
	target_link_libraries(luaviz-intermediate PUBLIC lua)
endif()

FetchContent_Declare(sol2 URL https://github.com/ThePhD/sol2/archive/main.zip)
FetchContent_MakeAvailable(sol2)
target_link_libraries(luaviz-intermediate PUBLIC sol2)
